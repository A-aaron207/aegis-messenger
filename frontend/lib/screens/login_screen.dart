...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // 1. Hash password locally (server never receives raw password)
      ...
      // 3. Private Key Recovery Fallback
      // If we are logging back into our existing device, the key is already in the secure vault.
      // If it's a new device or cleared state, generate a new identity keypair to avoid app crashing.
      final existingPrivateKey = await dbService.getPrivateKey();
      if (existingPrivateKey == null) {
        ...
        debugPrint('Identity keypair regenerated locally for new device session.');
      }

      // 4. Open WebSocket tunnel
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                ...
                child: const Text(
                  "Don't have an identity? Register here",
